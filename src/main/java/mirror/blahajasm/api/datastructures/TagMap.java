...
import mirror.blahajasm.api.datastructures.canonical.AutoCanonizingHashMap;
...
public class TagMap<K, V> implements Map<K, V> {
    ...
    public TagMap() {
        this(BlahajConfig.instance.optimizeNBTTagCompoundMapThreshold, BlahajConfig.instance.nbtBackingMapStringCanonicalization, BlahajConfig.instance.optimizeNBTTagCompoundBackingMap);
    }
