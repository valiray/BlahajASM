package mirror.blahajasm.core.classfactories;
...
import mirror.blahajasm.bakedquad.BakedQuadClassFactory;
...
public class BakedQuadRedirectorFactory {
    ...
    public static String generateRedirectorClass() {
        ...
        final String className = "mirror.blahajasm.client.models.bakedquad.mixins.NewBakedQuadCallsRedirector";
        ...
        if (!BlahajTransformer.squashBakedQuads) {
            ...
            for (String methodName : new String[] { "redirect", "staticRedirect", "deprecatedRedirect", "staticDeprecatedRedirect"} ) {
                ...
                methodVisitor.visitMethodInsn(INVOKESTATIC, "mirror/blahajasm/bakedquad/BakedQuadFactory", BlahajConfig.instance.vertexDataCanonicalization ? "canonicalize" : "prepare", "([IILnet/minecraft/util/EnumFacing;Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;ZLnet/minecraft/client/renderer/vertex/VertexFormat;)Lnet/minecraft/client/renderer/block/model/BakedQuad;", false);
