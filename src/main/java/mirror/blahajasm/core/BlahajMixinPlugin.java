...
import mirror.blahajasm.core.classfactories.BakedQuadRedirectorFactory;
...
public class BlahajMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        switch (mixinClassName) {
            case "mirror.blahajasm.common.forgefixes.mixins.ChunkMixin":
                return BlahajConfig.instance.fixTileEntityOnLoadCME;
            case "mirror.blahajasm.common.forgefixes.mixins.EntityEntryMixin":
                return BlahajConfig.instance.fasterEntitySpawnPreparation;
            case "mirror.blahajasm.common.forgefixes.mixins.DimensionTypeMixin":
                return BlahajConfig.instance.fixDimensionTypesInliningCrash;
            case "mirror.blahajasm.client.screenshot.mixins.MinecraftMixin":
                return BlahajConfig.instance.copyScreenshotToClipboard;
            case "mirror.blahajasm.client.screenshot.mixins.ScreenShotHelperMixin":
