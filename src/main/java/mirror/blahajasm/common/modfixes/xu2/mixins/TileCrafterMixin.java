package mirror.blahajasm.common.modfixes.xu2.mixins;
...
import mirror.blahajasm.common.modfixes.xu2.TileCrafterExtension;
...
public abstract class TileCrafterMixin extends TileEntity implements ITESRHook, TileCrafterExtension {
    ...
    public void preRender(int destroyStage) {
        if (!BlahajConfig.instance.disableXU2CrafterRendering) {
