...
public class GuiInitErrorScreen extends GuiProblemScreen {
    ...
    public void initGui() {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(1, width / 2 - 155,  height / 4 + 120 + 12, 310, 20, I18n.format("blahajasm.gui.getLink")));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) { // TODO: localize number of lines
        ...
        drawCenteredString(fontRenderer, I18n.format("blahajasm.initerrorscreen.title"), width / 2, height / 4 - 40, 0xFFFFFF);
        ...
        if (BlahajConfig.instance.crashReportUpdatedScreens) {
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.summary"), x, y -= 18, textColor);
            ...
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.new.paragraph3.line1"), x, y += 12, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.new.paragraph3.line2"), x, y += 9, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.new.paragraph3.line3"), x, y += 9, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.new.paragraph3.line4"), x, y + 9, textColor);
        }
        else {
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.summary"), x, y, textColor);
            ...
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.paragraph3.line1"), x, y += 12, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.paragraph3.line2"), x, y += 9, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.paragraph3.line3"), x, y += 9, textColor);
            drawString(fontRenderer, I18n.format("blahajasm.initerrorscreen.paragraph3.line4"), x, y + 9, textColor);
        }
