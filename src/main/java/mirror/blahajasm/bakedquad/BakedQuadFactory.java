...
/**
 * This class aids the dispatches of BakedQuad instances. The create method is removed/patched in {@link BlahajTransformer}
 */
...
public final class BakedQuadFactory {
    ...
    public static BakedQuad canonicalize(int[] vertexData, int tintIndex, EnumFacing face, TextureAtlasSprite sprite, boolean applyDiffuseLighting, VertexFormat format) {
        return prepare(BlahajVertexDataPool.canonicalize(vertexData), tintIndex, face, sprite, applyDiffuseLighting, format);
    }
