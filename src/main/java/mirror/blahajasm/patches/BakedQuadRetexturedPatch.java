package mirror.blahajasm.patches;
...
public final class BakedQuadRetexturedPatch {
    ...
    public static byte[] patchBakedQuadRetextured(byte[] originalClass) {
        ...
        }
        {
            ...
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuad", BlahajLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I");
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/vertex/VertexFormat", BlahajLoadingPlugin.isDeobf ? "getIntegerSize" : "func_181719_f", "()I", false);
            methodVisitor.visitVarInsn(ILOAD, 3);
            ...
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuadRetextured", "format", "Lnet/minecraft/client/renderer/vertex/VertexFormat;");
            methodVisitor.visitInsn(ICONST_0);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/vertex/VertexFormat", BlahajLoadingPlugin.isDeobf ? "getUvOffsetById" : "func_177344_b", "(I)I", false);
            methodVisitor.visitInsn(ICONST_4);
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuadRetextured", BlahajLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I");
            methodVisitor.visitVarInsn(ILOAD, 4);
            methodVisitor.visitVarInsn(ILOAD, 5);
            methodVisitor.visitInsn(IADD);
            methodVisitor.visitVarInsn(ALOAD, 2);
            methodVisitor.visitVarInsn(ALOAD, 1);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/block/model/BakedQuad", BlahajLoadingPlugin.isDeobf ? "getSprite" : "func_187508_a", "()Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", false);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuadRetextured", BlahajLoadingPlugin.isDeobf ? "vertexData" : "field_178215_a", "[I");
            methodVisitor.visitVarInsn(ILOAD, 4);
            methodVisitor.visitVarInsn(ILOAD, 5);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/texture/TextureAtlasSprite", BlahajLoadingPlugin.isDeobf ? "getUnInterpolatedU" : "func_188537_a", "(F)F", false);
            methodVisitor.visitInsn(F2D);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/texture/TextureAtlasSprite", BlahajLoadingPlugin.isDeobf ? "getInterpolatedU" : "func_94214_a", "(D)F", false);
            ...
            methodVisitor.visitInsn(IALOAD);
            methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Float", "intBitsToFloat", "(I)F", false);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/texture/TextureAtlasSprite", BlahajLoadingPlugin.isDeobf ? "getUnInterpolatedV" : "func_188536_b", "(F)F", false);
            methodVisitor.visitInsn(F2D);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/texture/TextureAtlasSprite", BlahajLoadingPlugin.isDeobf ? "getInterpolatedV" : "func_94207_b", "(D)F", false);
            methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Float", "floatToRawIntBits", "(F)I", false);
            methodVisitor.visitInsn(IASTORE);
            Label l9 = new Label();
        ...
        {
            methodVisitor = writer.visitMethod(ACC_PUBLIC, BlahajLoadingPlugin.isDeobf ? "hasTintIndex" : "func_178212_b", "()Z", null, null);
            methodVisitor.visitCode();
            Label l0 = new Label();
            methodVisitor.visitLabel(l0);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/block/model/BakedQuad", BlahajLoadingPlugin.isDeobf ? "hasTintIndex" : "func_178212_b", "()Z", false);
        ...
        {
            methodVisitor = writer.visitMethod(ACC_PUBLIC, BlahajLoadingPlugin.isDeobf ? "getTintIndex" : "func_178211_c", "()I", null, null);
            methodVisitor.visitCode();
            Label l0 = new Label();
            methodVisitor.visitLabel(l0);
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuadRetextured", "quad", "Lnet/minecraft/client/renderer/block/model/BakedQuad;");
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/block/model/BakedQuad", BlahajLoadingPlugin.isDeobf ? "getTintIndex" : "func_178211_c", "()I", false);
            methodVisitor.visitInsn(IRETURN);
            Label l1 = new Label();
            methodVisitor.visitLabel(l1);
            methodVisitor.visitLocalVariable("this", "Lnet/minecraft/client/renderer/block/model/BakedQuadRetextured;", null, l0, l1, 0);
        ...
        {
            methodVisitor = writer.visitMethod(ACC_PUBLIC, BlahajLoadingPlugin.isDeobf ? "getFace" : "func_178210_d", "()Lnet/minecraft/util/EnumFacing;", null, null);
            methodVisitor.visitCode();
            Label l0 = new Label();
            methodVisitor.visitLabel(l0);
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/renderer/block/model/BakedQuadRetextured", "quad", "Lnet/minecraft/client/renderer/block/model/BakedQuad;");
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/renderer/block/model/BakedQuad", BlahajLoadingPlugin.isDeobf ? "getFace" : "func_178210_d", "()Lnet/minecraft/util/EnumFacing;", false);
