 ...
 *
 * The original placeholder is removed: {@link mirror.blahajasm.bakedquad.BakedQuadFactory#create(int[], int, EnumFacing, TextureAtlasSprite, boolean, VertexFormat)}
...
public final class BakedQuadFactoryPatch {
    ...
    public static byte[] patchCreateMethod(byte[] originalClass) {
        ...
        methodVisitor.visitFieldInsn(GETSTATIC, "mirror/blahajasm/bakedquad/BakedQuadFactory", "pseudoSwitchMap", "[I");
