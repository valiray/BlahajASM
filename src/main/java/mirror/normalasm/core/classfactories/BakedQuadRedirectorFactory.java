package mirror.normalasm.core.classfactories;
...
public class BakedQuadRedirectorFactory {
    ...
    public static String generateRedirectorClass() {
        ...
        final String className = "mirror.normalasm.client.models.bakedquad.mixins.NewBakedQuadCallsRedirector";
        ...
        if (!NormalTransformer.squashBakedQuads) {
            ...
            for (String methodName : new String[] { "redirect", "staticRedirect", "deprecatedRedirect", "staticDeprecatedRedirect"} ) {
                ...
                methodVisitor.visitMethodInsn(INVOKESTATIC, "mirror/normalasm/bakedquad/BakedQuadFactory", NormalConfig.instance.vertexDataCanonicalization ? "canonicalize" : "prepare", "([IILnet/minecraft/util/EnumFacing;Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;ZLnet/minecraft/client/renderer/vertex/VertexFormat;)Lnet/minecraft/client/renderer/block/model/BakedQuad;", false);
